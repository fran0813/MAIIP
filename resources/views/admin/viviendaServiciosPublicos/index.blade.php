...
<div class="col-sm-12 col-md-12 collg-12">
    ...
    <div id="crear" class="col-sm-2 col-md-2 col-lg-2" hidden="">
       ...
       <a href="#" class="btn btn-primary pull-right" data-toggle="modal" data-target="#modalImportarViviendaServiciosPublicos">Importar</a>      
    </div>
...
@section('javascript')
    ...
    <script src="{{ asset('js/admin/viviendaserviciospublicos.js') }}"></script>
@endsection