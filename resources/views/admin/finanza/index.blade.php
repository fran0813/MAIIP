...
<div class="col-lg-12 col-md-12 col-sm-12">
	<div class="panel panel-default">
        <div class="panel-body">
            <div id="tablaFinanza" class="table-responsive">
...
@include('admin.modal.finanza.crear')
@include('admin.modal.finanza.mostrarActualizar')
@include('admin.modal.finanza.importar')
@endsection

@section('javascript')
    <script src="{{ asset('js/admin/main.js') }}"></script>
    <script src="{{ asset('js/admin/finanza.js') }}"></script>
@endsection