            ...
            <form id="formCrear">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">              
                        ...
                        <input id="tasVacBCG" type="number" pattern="[0-9]+" min="0" placeholder="Tasa de BCG" class="form-control" required>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <label for="tasVacDPT" class="text-label">DPT</label>     
                        <input id="tasVacDPT" type="number" pattern="[0-9]+" min="0" placeholder="Tasa de DPT" class="form-control" required>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <label for="tasVacHepatitisB" class="text-label">Hepatitis B</label>       
                        <input id="tasVacHepatitisB" type="number" pattern="[0-9]+" min="0" placeholder="Tasa de Hepatitis B" class="form-control" required>
                    </div>
                    <br>
                    <br>
                    <br>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        ...
                        <input id="tasVacHIB" type="number" pattern="[0-9]+" min="0" placeholder="Tasa de HIB" class="form-control" required>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <label for="tasVacPolio" class="text-label">Polio</label>       
                        <input id="tasVacPolio" type="number" pattern="[0-9]+" min="0" placeholder="Tasa de Polio" class="form-control" required>
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <label for="tasVacTripleViral" class="text-label">Triple viral</label>       
                        <input id="tasVacTripleViral" type="number" pattern="[0-9]+" min="0" placeholder="Tasa de Triple viral" class="form-control" required>
                    </div>
                </div>
