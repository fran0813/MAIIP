            ...
            <form id="formCrear">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <label for="codigoD" class="text-label">Código departamental</label>     
                        <input id="codigoD" type="number" pattern="[0-9]+" min="0" placeholder="Codígo departamental" class="form-control" required>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
