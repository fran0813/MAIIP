...
<div class="col-sm-12 col-md-12 collg-12">
    ...
    <div id="crear" class="col-sm-2 col-md-2 col-lg-2" hidden="">
       ...
       <a href="#" class="btn btn-primary pull-right" data-toggle="modal" data-target="#modalImportarEconomicoSocial>Importar</a>      
    </div>
...
<div class="col-lg-12 col-md-12 col-sm-12">
	<div class="panel panel-default">
        <div class="panel-body">
            <div id="tablaEconomicoSocial class="table-responsive">
...
@include('admin.modal.economicosocial.crear')
@include('admin.modal.economicosocial.mostrarActualizar')
@include('admin.modal.economicosocial.importar')
@endsection

@section('javascript')
    <script src="{{ asset('js/admin/main.js') }}"></script>
    <script src="{{ asset('js/admin/economicosocial.js') }}"></script>
@endsection