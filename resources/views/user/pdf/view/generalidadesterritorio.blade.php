...
@section('tables')
	...
	<form class="form-horizontal" method="GET" action='/generalidadesterritorio/pdf' enctype="multipart/form-data" target="_blank">
...
<script src="{{ asset('jquery/jquery.min.js') }}"></script>
	<script src="{{ asset('js/user/pdfgeneralidadesterritorio.js') }}"></script>
@endsection
