...
@section('tables')
	...
	<form class="form-horizontal" method="GET" action='/viviendaserviciospublicos/pdf' enctype="multipart/form-data" target="_blank">
...
<script src="{{ asset('jquery/jquery.min.js') }}"></script>
	<script src="{{ asset('js/user/pdfviviendaserviciospublicos.js') }}"></script>
@endsection
